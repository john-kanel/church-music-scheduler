            ...
            {googleCalendar?.connected ? (
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {/* Removed Connect Another Account button per request */}
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <h4 className="text-sm font-medium text-green-900 mb-2">📤 Share your Google Calendar (View Only)</h4>
                  <p className="text-sm text-green-800">
                    Open Google Calendar → Settings → Select the "[Church Name] Music Ministry" calendar → Share with specific people → add your team members → set permission to "See only (view only)". You can also copy the calendar’s shareable view link from Google Calendar and send it to your team.
                  </p>
                </div>
